...
const EuroStackingContainerPost = ({ data }) => {
  ...
  let cat_link = menu.euroStackingContainers.url
  return (
    <Layout>
...
EuroStackingContainerPost.propTypes = {
...
export default EuroStackingContainerPost

export const pageQuery = graphql`
  query EuroStackingContainerPostByID($id: String!) {
