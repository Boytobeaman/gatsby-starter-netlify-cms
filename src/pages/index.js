                  ...
                  <div className="text-left">
                    ...
                    <ul className="nav flex-column" id="homePageCatList">
                      <li className="nav-item">
                        <a className="nav-link text-danger font-weight-bold pb-0" href="#"><img className="" src="https://lu-ali-us-west.oss-us-west-1.aliyuncs.com/static/plastic-moving-crates.jpg"
